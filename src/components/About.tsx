...
const differentiators = [
  { icon: Laptop, label: "Estilo contemporáneo", description: "Enfoque moderno y digital-first." },
  { icon: Shield, label: "Enfoque preventivo", description: "Prevenir siempre es mejor que litigar." },
  { icon: Users, label: "Comunicación clara", description: "Sin jerga legal innecesaria." },
  { icon: Lightbulb, label: "Herramientas digitales", description: "Eficiencia con tecnología." },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          ...
          >
            ...
            <h3 className="font-serif text-2xl font-bold mb-4">Nuestra Misión</h3>
          ...
          >
            ...
            <h3 className="font-serif text-2xl font-bold mb-4">Nuestra Visión</h3>
